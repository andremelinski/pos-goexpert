...
type CategoryServiceClient interface {
	...
	ListCategory(ctx context.Context, in *Blank, opts ...grpc.CallOption) (*CategoryListResponse, error)
...
func (c *categoryServiceClient) ListCategory(ctx context.Context, in *Blank, opts ...grpc.CallOption) (*CategoryListResponse, error) {
...
type CategoryServiceServer interface {
	...
	ListCategory(context.Context, *Blank) (*CategoryListResponse, error)
...
func (UnimplementedCategoryServiceServer) ListCategory(context.Context, *Blank) (*CategoryListResponse, error) {
